...
* <p>To ensure the proper saving and execution of the script, follow these steps:
    
    1. Save the Script:</br>
Save the script, but refrain from immediately clicking "Start." This precaution is taken to prevent any potential issues with Shelly that may occur if you initiate the start process too quickly.
    
    2. Allow Saving to Finish:</br>
After clicking "Save," wait for Shelly to complete the saving process. This may take 5-8 seconds. It's crucial to allow the device to finalize the saving job.
    
    3. Initiate Start: </br>
Once the saving process is complete, click "Start" to commence the execution of the script.

    By following this sequence, you can help prevent any potential complications that may arise during the saving and starting processes
